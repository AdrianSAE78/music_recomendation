...
function templateCancionAleatoria(data) {
    ...
    let contenedor = document.getElementById('random');
    let firstChild = contenedor.firstElementChild;
    ...
    let handleVote = async () => {
        ...
        try {
            ...
            alert("Error al actualizar votos");
        }
    };
    ...
    if (firstChild) {
        ...
        setTimeout(() => {
            ...
            contenedor.appendChild(clonedTemplate);
        }, 300);
